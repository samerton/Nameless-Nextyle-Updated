  ...
  <div class="card-block">
	<div class="container">
	  ...
	  <form action="" method="post">
		...
		<a href="#" class="btn btn-{$NEXTYLE_COLOR}" data-toggle="modal" data-target="#cancelModal">{$CANCEL}</a>
	  </form>
	</div>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-{$NEXTYLE_COLOR}" data-dismiss="modal">{$CLOSE}</button>
        <a href="{$FORUM_LINK}" class="btn btn-{$NEXTYLE_COLOR}">{$CANCEL}</a>
      </div>
    </div>
  </div>
</div>