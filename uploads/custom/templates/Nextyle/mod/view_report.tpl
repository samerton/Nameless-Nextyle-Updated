	  ...
	  <div class="card">
		<div class="card-block">
		  ...
		  <span class="pull-right">
		    <a href="{$REPORTS_LINK}" class="btn btn-{$NEXTYLE_COLOR}">{$BACK}</a>
		  </span>
		  ...
		  <form action="" method="post">
			...
			<div class="form-group">
			  ...
			  <input type="submit" value="{$SUBMIT}" class="btn btn-{$NEXTYLE_COLOR}">
			  <span class="pull-right">
			    {if isset($CLOSE_REPORT)}
				  <a href="{$CLOSE_LINK}" class="btn btn-red">{$CLOSE_REPORT}</a>
				{else}
				  <a href="{$REOPEN_LINK}" class="btn btn-red">{$REOPEN_REPORT}</a>
				{/if}
			  </span>
			</div>
		  </form>
