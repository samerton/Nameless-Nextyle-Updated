		...
		<div class="card-block">
		  <form action="" method="post">
			...
			<div class="row">
			  ...
			  <div class="col-xs-12 col-md-6"><input type="submit" value="{$REGISTER}" class="btn btn-{$NEXTYLE_COLOR} btn-block btn-lg" tabindex="8"></div>
			  <div class="col-xs-12 col-md-6"><a href="{$LOGIN_URL}" class="btn btn-{$NEXTYLE_COLOR} btn-block btn-lg">{$LOG_IN}</a></div>
			</div>
		  </form>
		</div>
	  </div>
