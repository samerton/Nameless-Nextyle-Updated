	  ...
	  <div class="card">
		<div class="card-block">
		  ...
		  <span class="pull-right">
			...
			<a href="{$LEAVE_CONVERSATION_LINK}" class="btn btn-{$NEXTYLE_COLOR}" onclick="return confirm('{$CONFIRM_LEAVE}');">{$LEAVE_CONVERSATION}</a>
		  </span>
		  ...
		  <form action="" method="post">
			...
			<div class="form-group">
			  ...
			  <input type="submit" name="{$SUBMIT}" class="btn btn-{$NEXTYLE_COLOR}">
			</div>
		  </form>
