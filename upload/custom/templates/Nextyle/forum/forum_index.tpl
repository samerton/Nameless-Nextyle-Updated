                            ...
                            {if !empty($forum.subforums)}
                                ...
                                <div class="card-block">
                                    {foreach from=$forum.subforums item=subforum}
                                        <div class="row">
                                            <div class="col-md-6">
                                                <a href="{if !isset($subforum->redirect_confirm)}{$subforum->link}{else}#"
                                                   data-toggle="modal"
                                                   data-target="#confirmRedirectModal{$subforum->id}{/if}">{$subforum->forum_title}</a>
                                            ...
                                            {else}
                                                <div class="modal fade" id="confirmRedirectModal{$subforum->id}"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-primary"
                                                                   href="{$subforum->redirect_url}" target="_blank"
                ...
                <div class="col-md-3">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="{$SEARCH_URL}">
                        <div class="input-group">
                            <input type="text" class="form-control input-sm" name="forum_search"
                                   placeholder="{$SEARCH}">
