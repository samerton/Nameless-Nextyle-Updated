			    ...
			    <div class="row">
				  ...
				  <div class="col-md-4">
					...
					<div class="row">
				      <div class="col-md-3">
						<div class="frame">
						  <a href="{$subforum->last_post->profile}"><img alt="{$subforum->last_post->profile}" class="img-centre img-rounded" src="{$subforum->last_post->avatar}" style="max-height:40px; max-width:40px;"/></a>
						</div>
					  </div>
					  <div class="col-md-9">
