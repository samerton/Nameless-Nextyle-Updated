...
<div class="container">
	...
	{if isset($CAN_REPLY)}
		...
		<a{if isset($LOCKED) && !isset($CAN_MODERATE)} disabled="disabled"{else} href="#reply_section"{/if}
                ...
                class="btn btn-{if isset($LOCKED) && !isset($CAN_MODERATE)}warning disabled{else}{$NEXTYLE_COLOR}{/if}">{if isset($LOCKED) && !isset($CAN_MODERATE)}
    ...
    {/if}
                {if isset($CAN_MODERATE)}
                    <div class="btn-group">
	  <button type="button" style="vertical-align:baseline;" class="btn btn-{$NEXTYLE_COLOR} dropdown-toggle"
            ...
            {foreach from=$REPLIES item=reply name=arr}
                <div class="panel panel-{$NEXTYLE_COLOR}">
                    <div class="panel-heading">
                        <a href="{$reply.url}" class="white-text">{if isset($LOCKED) && $smarty.foreach.arr.first}
                    ...
                    <div class="panel-body" id="post-{$reply.id}">
                        <div class="row">
                            <div class="col-md-3">
                                <center>
                                    <img class="img-rounded" style="max-width:100px; max-height:100px;"
                                         src="{$reply.avatar}"/>
                                    <br/><br/>
                                    <strong><a style="{$reply.user_style}"
                                               href="{$reply.profile}" data-poload="{$USER_INFO_URL}{$reply.user_id}" data-html="true" data-placement="top">{$reply.username}</a></strong>
                                    <br/>
              ...
              {/if}
                                    ...
                                    {if isset($reply.buttons.report)}
                                        <button class="btn btn-warning btn-sm" rel="tooltip" data-trigger="hover"
                                                data-original-title="{$reply.buttons.report.TEXT}" data-toggle="modal"
                                                data-target="#report{$reply.id}Modal"><i
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"
                                        id="report{$reply.id}ModalLabel">{$reply.buttons.report.TEXT}</h4>
                                </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"
                                        id="delete{$reply.id}ModalLabel">{$CONFIRM_DELETE_SHORT}</h4>
                                </div>
                                <div class="modal-body">
                                    {$CONFIRM_DELETE_POST}
                                </div>
            ...
            {if isset($CAN_REPLY)}
                <div id="reply_section">
                    ...
                    <form action="" method="post">
                        ...
                        <button type="button" class="btn btn-{$NEXTYLE_COLOR}" id="quoteButton"
