	  ...
	  <div class="card">
	    <div class="card-block">
		  <form role="form" action="" method="post">
			  ...
			  <div class="row">
				...
				<div class="col-xs-12 col-md-6">
				  <span class="pull-right">
					<a class="btn btn-{$NEXTYLE_COLOR}" href="{$FORGOT_PASSWORD_URL}">{$FORGOT_PASSWORD}</a>
				  </span>
				</div>
			  </div>
			</div>
			...
			<div class="row">
			  <div class="col-xs-12 col-md-6">
				<input type="submit" class="btn btn-{$NEXTYLE_COLOR} btn-block btn-lg" value="{$SIGN_IN}">
			  </div>
			  <div class="col-xs-12 col-md-6">
				<a class="btn btn-{$NEXTYLE_COLOR} btn-block btn-lg" href="{$REGISTER_URL}">{$REGISTER}</a>
			  </div>
			</div>
		  </form>
	    </div>
